...
class APIClient(object):
    def __init__(self, app_key, app_secret, redirect_uri=None,response_type='code', domain='api.weibo.com', version='2',state='/'):
    ...
    def get_authorize_url(self):
        return "https://api.weibo.com/oauth2/authorize?response_type=code&client_id=%s&redirect_uri=%s&state=%s"%(self.client_id, self.redirect_uri,self.state)
